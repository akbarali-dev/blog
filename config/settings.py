...
ALLOWED_HOSTS = ["http://localhost:5000", "*", "pyback.javthon.uz", "0.0.0.0", "localhost", "http://37.110.210.14"]
# ALLOWED_HOSTS = ["*"]
...
AUTHENTICATION_BACKENDS = [
    'custom_auth.backends.JWTOrSessionAuthenticationBackend',
]
...
MIDDLEWARE = [
    ...
    'contrib.seasons.middleware.VisitorMiddleware'
]
